...
class PhieuSuaChua {
  ...
  /// Factory constructor to create NewCompensationModel from Firestore document
  ...
  /// Convert NewCompensationModel to a Map for Firestore
