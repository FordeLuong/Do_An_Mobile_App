...
class _QuanLyPhieuSuaChuaScreenState extends State<QuanLyPhieuSuaChuaScreen> 
  ...
  Future<void> _loadPhieuSuaChua() async {
    try {
      final list = await _phieuSuaChuaService.getPhieuSuaChuaByRoom(widget.roomId);
      setState(() {
        _phieuList = list;
        _isLoading = false;
      });
  ...
  Future<void> _savePhieuSuaChua(PhieuSuaChua phieu) async {
    try {
      await _phieuSuaChuaService.savePhieuSuaChua(phieu);
  ...
  Future<void> _deletePhieu(String phieuId) async {
    ...
    if (confirm == true) {
      try {
        await _phieuSuaChuaService.deletePhieuSuaChua(phieuId);
